...
<body>
    ...
    <script>
        ...
        function filterTable() {
            ...
            genderFilter = document.getElementById('genderFilter').value.toUpperCase(); // Convert filter to uppercase
            classFilter = document.getElementById('classFilter').value.toUpperCase(); // Convert filter to uppercase
            table = document.getElementById('studentTable');
            tr = table.getElementsByTagName('tr');
            ...
            for (i = 1; i < tr.length; i++) {
                ...
                if (td) {
                    gender = (td[3].textContent || td[3].innerText).toUpperCase().trim(); // Gender column
                    classValue = (td[5].textContent || td[5].innerText).toUpperCase().trim(); // Class column
        
                    // Compare gender and class using strict equality
                    if ((gender === genderFilter || genderFilter === '') && 
                        (classValue === classFilter || classFilter === '')) {
                        tr[i].style.display = "";
                    } else {
                        tr[i].style.display = "none";
                    }
